    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data', models.CharField(blank=True, default=None, help_text='время, когда необходимо выполнять привычку', max_length=50, null=True, verbose_name='время выполнения привычки')),
                ...
                ('related', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='related', to=settings.AUTH_USER_MODEL)),
